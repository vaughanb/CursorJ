...
/**
 * Cursor exposes MAX Mode and similar controls via ACP [com.cursorj.acp.messages.ConfigOption]
 * on `session/new` and `session/set_config_option`. Exact ids/types may vary by agent version;
 * enable **ACP raw JSON debug logging** in CursorJ settings to inspect live payloads.
 *
 * Typical shapes:
